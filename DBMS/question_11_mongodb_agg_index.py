...
def setup_data_and_indexes(c):
    """Create indexes and insert sample data if collection is empty."""
...
def run_aggregation_pipelines(c):
    """Run and print results from aggregation pipelines."""
    print("\n--- Aggregation 1: Average marks per age ---")
...
def main():
    ...
    c = get_collection()
    setup_data_and_indexes(c)
    run_aggregation_pipelines(c)
...
# //----------------------------------------------------
# db.sales.getIndexes()
# // Output: shows _id_, category_1_city_1, product_1
